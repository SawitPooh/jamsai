...
export default function SurveyIntro() {
    ...
    return (
        <main className="min-h-screen flex flex-col items-center justify-between p-6 bg-gradient-to-br from-pink-100 via-purple-100 to-white">
            {/* Indicator */}
            <div className="w-full flex justify-center space-x-4 mt-4">
                {slides.map((_, i) => (
                    <div
                        ...
                        style={{ width: '80px' }} // ปรับความยาวเส้นตรงนี้
                    />
                ))}
            </div>
            ...
            {/* Slide Content */}
            <div className="bg-white bg-opacity-40 p-6 rounded-xl shadow-lg max-w-lg w-full mt-4 text-center">
                <h2 className="text-xl font-bold text-blue-700 mb-4 whitespace-pre-wrap">{slide.title}</h2>
            ...
            <div className="w-full max-w-md mt-8">
                ...
                <button
                    onClick={skip}
                    className="w-full text-indigo-600 text-sm mt-3 underline"
                >
                    ข้าม
                </button>
            </div>
