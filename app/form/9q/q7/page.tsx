...
import { saveAnswer, getAnswers } from '@/app/utils/q9Storage'; // <-- ใช้ utils ของ 9Q
...
export default function Q7Page() {
  ...
  const handleSelect = (score: number) => {
    ...
    saveAnswer('q7', score);
    router.push('/form/9q/q8');
  };

  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-orange-50 p-6">
      <h1 className="text-xl font-bold text-center mb-4">Q: 7/9</h1>
      <p className="text-center mb-6">
        ใน 2 สัปดาห์ที่ผ่านมา รวมถึงวันนี้
        <br />
        ท่านมีอาการ สมาธิลด เวลาทำอะไร เช่น ดูโทรทัศน์ ฟังวิทยุ หรือทำงานที่ต้องใช้ความตั้งใจ บ่อยแค่ไหน
      </p>
