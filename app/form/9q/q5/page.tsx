...
import { saveAnswer, getAnswers } from '@/app/utils/q9Storage'; // <-- utils สำหรับ 9Q
...
export default function Q5Page() {
  ...
  const handleSelect = (score: number) => {
    ...
    saveAnswer('q5', score);
    router.push('/form/9q/q6'); // ไปหน้าถัดไป
  };

  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-orange-50 p-6">
      <h1 className="text-xl font-bold text-center mb-4">Q: 5/9</h1>
      <p className="text-center mb-6">
        ใน 2 สัปดาห์ที่ผ่านมา รวมถึงวันนี้
        <br />
        ท่านมีอาการ เบื่ออาหาร หรือกินมากเกินไป บ่อยแค่ไหน
      </p>
