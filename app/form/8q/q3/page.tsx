...
export default function EightQ3Page() {
  ...
  const handleSelect = (score: number) => {
    ...
    if (score === 0) {
      router.push('/form/8q/q4');  // ถ้า "ไม่มี" ไป Q4 เลย
    } else {
      router.push('/form/8q/q3_1'); // ถ้า "มี" ไป Q3_1
    }
  };
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-red-50 p-6">
      ...
      <div className="bg-red-200 text-red-700 font-semibold p-4 rounded-lg mb-6 text-center">
        ...
        <br />
        ท่านคิดเกี่ยวกับการฆ่าตัวตาย บางไหม
      </div>

      {/* ตัวเลือก */}
      <div className="flex flex-col gap-4 mb-8 w-64">
        {[{ score: 0, text: 'ไม่มี' }, { score: 6, text: 'มี' }].map((choice) => (
          <button
            key={choice.score}
